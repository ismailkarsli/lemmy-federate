              ...
              <template v-slot:label>
                ...
                <v-col v-if="!isGeneric" cols="12">
                    ...
                    <v-row>
                        ...
                        <v-checkbox label="Don't allow censured" v-model="instance.fediseer" value="BLACKLIST_ONLY"
                            hide-details />
                        <v-checkbox label="Allow only endorsed" v-model="instance.fediseer" value="WHITELIST_ONLY"
                            hide-details />
                    </v-row>
                </v-col>
