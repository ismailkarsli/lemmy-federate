									...
									>
										<template v-slot:activator="{ props }">
											<v-chip color="success" class="mr-2" v-bind="props">
												{{ item.progress.federatedByUser.length }}
												federated by user
											</v-chip>
										</template>
									...
									>
										<template v-slot:activator="{ props }">
											<v-chip color="warning" class="mr-2" v-bind="props">
												{{ item.progress.federatedByBot.length }}
												federated by bot
											</v-chip>
										</template>
											...
											<v-list density="compact">
												...
												>
													<v-list-item-title>
														...
														<v-tooltip
															v-if="follow.errorReason"
															:text="`Error reason: ${follow.errorReason}`"
														>
															<template v-slot:activator="{ props }">
																<v-icon
																	v-bind="props"
									...
									>
										<template v-slot:activator="{ props }">
											<v-chip color="grey" class="mr-2" v-bind="props">
												{{ item.progress.notAllowed.length }}
												not allowed
											</v-chip>
										</template>
